...
@section('page-title','Nestable List')
@section('breadcrumb')
...
<div class="row-fluid">
    <div class="span6">
        <div class="portlet box blue">
            <div class="portlet-title">
                <h4><i class="icon-comments"></i>Nestable List 1</h4>
                <div class="tools">
    ...
    <div class="span6">
        <div class="portlet box green">
            <div class="portlet-title">
                <h4><i class="icon-comments"></i>Nestable List 2</h4>
                <div class="tools">
                    <a href="javascript:;" class="collapse"></a>
                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                    <a href="javascript:;" class="reload"></a>
...
<div class="row-fluid">
    <div class="span6">
        <div class="portlet box yellow">
            <div class="portlet-title">
                <h4><i class="icon-comments"></i>Nestable List 3</h4>
                <div class="tools">
                    <a href="javascript:;" class="collapse"></a>
                    <a href="#portlet-config" data-toggle="modal" class="config"></a>
                    <a href="javascript:;" class="reload"></a>
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <div class="portlet box green">
                ...
                <div class="portlet-body">
                    ...
                    <p>
                        <button class="btn yellow btn-block" type="button">Block button</button>
                    </p>
                </div>
            </div>
            <!-- END BUTTONS PORTLET-->
            ...
            <div class="portlet box red">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Icon Buttons</h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        <a href="javascript:;" class="reload"></a>
        ...
        <div class="span6">
            ...
            <div class="portlet box purple">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Dropdowns</h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        <a href="javascript:;" class="reload"></a>
                ...
                <div class="portlet-body">
                    ...
                    <form>
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <div class="input-prepend">
                                    <span class="add-on"><i class="icon-key"></i></span><input class="m-wrap" id="inputIcon2" type="text" placeholder="Password" />
                                </div>
                            </div>
                        </div>
                    </form>
            ...
            <div class="portlet box blue">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Font Awesome Buttons</h4>
                </div>
                <div class="portlet-body">
                    <div class="row-fluid">
