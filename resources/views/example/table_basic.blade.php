...
@section('page-title','Basic Tables')
@section('breadcrumb')
    <li><a>Data Tables</a> <i class="icon-angle-right"></i></li>
...
@section('content')
    <div class="row-fluid">
        <div class="span6">
            ...
            <div class="portlet box red">
                <div class="portlet-title">
                    <h4><i class="icon-cogs"></i>Simple Table</h4>
                    <div class="tools">
        ...
        <div class="span6">
            ...
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <h4><i class="icon-coffee"></i>Bordered Table</h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        <a href="javascript:;" class="reload"></a>
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <div class="portlet box purple">
                <div class="portlet-title">
                    <h4><i class="icon-comments"></i>Striped Table</h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        <a href="javascript:;" class="reload"></a>
        ...
        <div class="span6">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <h4><i class="icon-picture"></i>Condensed Table</h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        <a href="javascript:;" class="reload"></a>
    ...
    <div class="row-fluid">
        <div class="span6">
            ...
            <div class="portlet">
                <div class="portlet-title">
                    <h4><i class="icon-bell"></i>Advance Table</h4>
                    <div class="tools">
                        <a href="javascript:;" class="collapse"></a>
                        <a href="#portlet-config" data-toggle="modal" class="config"></a>
                        <a href="javascript:;" class="reload"></a>
