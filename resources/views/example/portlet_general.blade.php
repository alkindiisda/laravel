...
@section('page-title','General Portlets')
@section('breadcrumb')
    <li><a>{{Session::get('cur')}}</a> <i class="icon-angle-right"></i></li>
    <li><a>General Portlets</a></li>
@stop
...
@section('content')
    <div class="row-fluid">
        <div class="span4 ">
            ...
            <div class="portlet box grey">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Portlet1</h4>
                    <div class="actions">
        ...
        <div class="span4 ">
            ...
            <div class="portlet box red">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Portlet2</h4>
                    <div class="tools">
        ...
        <div class="span4 ">
            ...
            <div class="portlet box yellow">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Portlet3</h4>
                    <div class="actions">
                        <div class="btn-group">
    ...
    <div class="row-fluid">
        ...
        <div class="span3 ">
            ...
            <div class="portlet box green">
                <div class="portlet-title">
                    <h4><i class="icon-reorder"></i>Collapsed</h4>
                    <div class="tools">
