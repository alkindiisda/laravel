                ...
                <div class="span12">
                    ...
                    <div class="portlet ">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Alerts</h4>
                            <div class="tools">
            ...
            <div class="row-fluid">
                <div class="span6">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Inline Notifications</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Gritter Notifications</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload hidden-phone"></a>
                    ...
                    <div class="portlet box grey">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Pulsate</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload"></a>
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Modal Dialogs</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload"></a>
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Tooltips</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload"></a>
                        ...
                        <div class="portlet-body">
                            <p>
                                ...
                                <a href="#" class="tooltips" title="The last tip!">twitter handle</a>
                    ...
                    <div class="portlet box yellow">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Popovers</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload"></a>
                ...
                <div class="span6">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Labels and Badges</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload"></a>
                    ...
                    <div class="portlet box purple">
                        <div class="portlet-title">
                            <h4><i class="icon-cogs"></i>Pagination</h4>
                            <div class="tools">
                                <a href="javascript:;" class="collapse"></a>
                                <a href="#portlet-config" data-toggle="modal" class="config"></a>
                                <a href="javascript:;" class="reload"></a>
